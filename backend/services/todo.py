from models.todo import insert_todo, get_all_todos, update_todo_done, update_todo_priority, delete_todo
...
def create_todo(text: str) -> dict:
    ...
    todo_id = insert_todo(text, ai_result['category'], ai_result['priority'])
    return {
        'ok': True,
        'id': todo_id,
